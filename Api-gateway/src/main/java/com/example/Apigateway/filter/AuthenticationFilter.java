...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    private boolean isAuthorized(String role, String path, String method) {
		/*
		 * if ("ADMIN".equalsIgnoreCase(role)) { return path.startsWith("/cart") ||
		 * path.startsWith("/products"); } else if ("USER".equalsIgnoreCase(role)) {
		 * return (path.startsWith("/cart") || path.startsWith("/products")) &&
		 * method.equalsIgnoreCase("GET"); } return false;
		 */
    	return true;
    }
